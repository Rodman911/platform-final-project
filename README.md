...
- 3.接受者：当一个平台的用户向朋友或熟人传递价值单元时，如果接受者发现价值单元中肯、有趣、有用、令人愉快或者具备其他价值，那么他将做出回应。当价值单元足以激发接受者的兴趣，他们将会进一 步对其传播，有时候会在其他社交网络引发新的互动。如一名来自微博、微信等的用户对小视频或瓜分红包的活动产生兴趣，然后访问抖音app，参与活动。然后开始循环上述过程，从而接受者成了发送者。  
